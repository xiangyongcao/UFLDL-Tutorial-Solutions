...
% Shuffle examples.
data = data(:, randperm(size(data,2)));%数据重新洗牌
...
%   legend('Actual Price', 'Predicted Price','Location','Best');
%   xlabel('House #');
...
disp(['The final average gradient check is: ',num2str(average_error)]);
fprintf('Optimization in vector form took %f seconds.\n', toc);
